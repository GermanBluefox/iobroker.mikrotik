...
// this code can be placed directly in mikrotik.html
vis.binds.mikrotik = {
    version: "0.5.0",
    showVersion: function () {
        if (vis.binds.mikrotik.version) {
            console.log('Version mikrotik: ' + vis.binds.mikrotik.version);
            vis.binds.mikrotik.version = null;
        }
    },
	createWidget: function (widgetID, view, data, style) {
        ...
        if (!$div.length) {
            return setTimeout(function () {
                vis.binds.mikrotik.createWidget(widgetID, view, data, style);
            }, 100);
        }
        ...
        if (data.oid) {
            vis.states.bind(data.oid + '.val', function (e, newVal, oldVal) {
                $div.find('.mikrotik-value').html(newVal);
            });
        }
    }
};
	
vis.binds.mikrotik.showVersion();
